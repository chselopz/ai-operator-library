...
A core truth to anchor on: in remote support, there is no "do nothing" option — every organization needs a remote support tool. So if this customer leaves, they are moving TO a competitor. The case for leaving always has a destination.
...
Competitor they may move to: [COMPETITOR — or leave blank. If blank, infer the most likely remote-support competitor(s) for this customer based on their industry, size, and the signals below. Remember: in remote support there is no "do nothing" option — if they leave, they are going somewhere.]
...
[What they've said or hinted — tools named, pricing referenced, new IT leadership.]
---

RESEARCH RULES
- Research my product and the competitor's product for the competitive comparison. Use publicly available sources.
...
A markdown table comparing my product against the competitor (named or your inferred most-likely), focused on the dimensions THIS customer cares about based on their usage and signals:

| Dimension | My Product | Competitor | Edge |

Then one paragraph: through this customer's eyes, where does the competitor genuinely win?
